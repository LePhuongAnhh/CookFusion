                        ...
                        <table className={cx('table table-hover')}>
                            <thead>
                                <tr className={cx('header')}>
                                    <th className={cx('text-color')} scope='col'></th>
                                    <th className={cx('text-color')} scope='col'>Account</th>
                                    <th className={cx('text-color')} scope='col' >Email</th>
                                    ...
                                    <th className={cx('text-color')} scope='col'>Address</th>
                                    <th className={cx('text-color')} scope='col'>Recipe</th>
                                    <th className={cx('text-color')} scope='col'>Advertisement</th>
                                    <th className={cx('text-color')} scope='col'>Amount</th>
                                    <th className={cx('text-color')} scope='col'>Disable</th>
                                </tr>
                            </thead>
                            <tbody>
                                <tr className={cx('align-middle', 'hover-actions-trigger')}>
                                    <td className={cx('text-nowrap', 'text-color')} style={{ paddingRight: '35px' }}>
                                    </td>
