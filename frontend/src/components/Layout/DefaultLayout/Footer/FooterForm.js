...
const FooterForm = () => {
    return (
        <>
            <footer className={cx('dk_footer')}>
                <div className={cx('footer_container')}>
                    <div className={cx('footer_left')}>
                        <div className={cx('dk_footer_box_info')}>
                            <Link to="/homepage" className={cx('footer_logo')}>
                                {/* <img src={logofooter} alt="footer_logo" className={cx('img_fluid} /> */}
                            </Link>
                            <p className={cx('footer_info_text')}>
                                Reference site about Lorem Ipsum,
                            </p>
                            <div className={cx('footer_social_link')}>
                                <h3>Follow us</h3>
                                <ul>
                                    <li>
                                        <Link to="#">
                        ...
                        <div className={cx('row')}>
                            <div class="col-md-12 col-lg-6">
                                <div className={cx('footer_widget')}>
                                    <div className={cx('section_heading')}>
                                        <h3>Useful Links</h3>
                                        <span className={cx('animate_border')}></span>
                                    </div>
                                    <ul>
                                        <li>
                                ...
                                <div className={cx('footer_widget')}>
                                    ...
                                    <form action="#">
                                        <div className={cx('form_row')}>
                                            <div className={cx('dk_footer_form')}>
                                                <input type="email" className={cx('form_control')} placeholder="Email Address" />
                                                <button type="submit">
