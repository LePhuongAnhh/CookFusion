                ...
                <div className={style.nav_wrap}>
                    <div className={style.nav_left}>
                        ...
                        <div className={style.nav_menu}>
                            <div className={style.nav_smaller_heading}>
                        ...
                        <h4 className={style.nav_nameweb}>
                            ...
                            <div className={style.letter}>u</div>
                    ...
                    <div className={style.nav_action}>
                        <div>
                            <div className={style.search_wrapper}>
                                ...
                                <div className={style.nav_separator}></div>
                                <input className={style.search_input} placeholder='Search' />
                                <div className={style.nav_search_cancel}>
                            ...
                            <div className={style.search_box}>
                                ...
                                <Link to="#" className={style.search_icon_res}>
