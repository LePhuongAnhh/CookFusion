                        ...
                        <div className={style.dk_footer_box_info}>
                            ...
                            <div className={style.footer_social_link}>
                                ...
                                <ul>
                                    <li>
                                        <Link to="#">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="38" height="56" fill="currentColor" class="bi bi-facebook" viewBox="0 0 16 16">
                                    ...
                                    <li>
                                        <Link to="#">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="38" height="56" fill="currentColor" class="bi bi-twitter" viewBox="0 0 16 16">
                                    ...
                                    <li>
                                        <Link to="#">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="38" height="56" fill="currentColor" class="bi bi-instagram" viewBox="0 0 16 16">
