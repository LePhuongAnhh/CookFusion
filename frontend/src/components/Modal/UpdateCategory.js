...
function UpdateCategory({ setShowUpdateCategoryModal, showUpdateCategoryModal, categoryData }) {
    ...
    return (
        <div className={cx('modalUpdateCategory')} style={{ display: showUpdateCategoryModal ? 'block' : 'none' }}>
                        ...
                        <Form onSubmit={handleSubmit}>
                            ...
                            <Form.Group controlId="formGroupImage">
                                <div className={cx('image-select-container')}>
                                    {selectedFile ? ( // Display the selected file if available
                                        <img
                                            src={URL.createObjectURL(selectedFile)}
                                            alt="Selected file"
                                            className={cx('image-select')}
                                        />
                                    ) : ( // Otherwise, display the existing image
                                        <img
                                            src={image}
                                            alt="Category"
                                            className={cx('image-select')}
